    ...
    return (
        <footer className={'main-footer'}>
            <div className="main-left-info">
                <h1 className={'text-[#5865f2] font-semibold text-[32px] '}>
                    ПРЕДСТАВЬТЕ <br/> СЕБЕ...
                </h1>
                <div className={'flex flew-row'} >
                    <a href="src/components/Footer#" className={'text-white'} >
                        <svg width="24" height="24" viewBox="0 0 24 24" className="main-socialIcon-38NB2e">
                    ...
                    <a href="src/components/Footer#" className={'text-white ml-[20px]'} >
                        <svg width="24" height="24" viewBox="0 0 24 24" className="main-socialIcon-38NB2e">
                            <g fill="currentColor">
            ...
            <div className="main-column">
                <div className="main-column-title">
                    Продукт
                </div>
                <div>
